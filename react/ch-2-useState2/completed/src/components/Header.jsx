        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">
              배열 상태 업데이트, 객체 상태 관리, 부모에서 자식으로 함수 전달하기를 한 화면에서
              연습할 수 있도록 구성한 예제입니다.
            </p>
          </div>

          <div className="self-start rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
