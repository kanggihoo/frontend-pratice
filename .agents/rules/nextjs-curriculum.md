...
- _참고: 빠른 실험 및 독립 모듈 개발 시에는 Vite 환경을 접목시킬 수 있으나 본 애플리케이션의 뼈대는 Next.js Turbopack 사용_
...
- [x] 회차 3 — 서버사이드 데이터 페칭 및 렌더링 전략
- [x] 회차 4 — 동적 라우팅 및 네비게이션
- [x] 회차 5 — 로딩, 에러 UI 및 Suspense
- [x] 회차 6 — Route Handlers (자체 API 엔드포인트 구축)
- [x] 회차 7 — Server Actions (서버 액션) 기초
- [x] 회차 8 — 데이터 재검증(Revalidation)
- [x] 회차 9 — 성능 최적화 (Image, Font, Meta 등)
- [x] 회차 10 — Proxy (Middleware) 및 인증 연계
- [ ] 회차 11 — 고급 훅 연동 (`useActionState`, `useFormStatus`)
- [ ] 회차 12 — 종합 프로젝트
