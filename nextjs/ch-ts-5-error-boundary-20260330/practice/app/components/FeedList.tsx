...
// ─── [제네릭 Promise 반환 타입] ────────────────────────────────────
// JavaScript: async function getPosts(shouldError) { ... }
// TypeScript: 반환 타입을 명시합니다.
// 힌트: async function getPosts(shouldError: boolean): Promise<Post[]>

// TODO: 함수 매개변수와 반환 타입을 추가하세요.
async function getPosts(shouldError) {   // ← 타입 없음 (에러 발생)
...
export default async function FeedList({ shouldError = false }) {   // ← 타입 없음 (에러 발생)
