...
// 서버 컴포넌트는 async function — 반환 타입은 JSX.Element로 자동 추론
export default async function Home() {
  // 실제 앱에서는 fetch + next: { tags: ['posts'] } 로 캐싱
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      <div className="flex items-center justify-between mb-6">
        ...
        {/* RefreshButton: refreshPosts() 호출 → revalidateTag('posts') + revalidatePath('/','layout') */}
        <RefreshButton />
      </div>
